Create one horizontal animation strip for Codex pet `nono`, state `running-right`.
...
Identity: same pet in every frame: Original soft futuristic Codex desktop pet named NoNo: small floating assistant robot, white rounded capsule body, black glossy screen face, two cyan symbolic eyes, blue-white rabbit-ear energy antennae, tiny side thrusters or light wings, subtle circuit lines, transparent energy core, affectionate protective calm coding companion. Avoid copying any franchise-specific details; keep it original, minimal, readable, and pet-safe.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
